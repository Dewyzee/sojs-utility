...
sojs.define({
	 ...
	 * @name this.md5
	 * @function
	 * @param {String} string 要生成MD5签名的字符串
	 *
	...
	md5: function (string) {
		...
		var hightBit = ((parseInt("0x" + this.wordToHex(a), 16) + parseInt("0x"
			+ this.wordToHex(b), 16)) % 4294967296).toString(16);
		var lowBit = ((parseInt("0x" + this.wordToHex(c), 16) + parseInt("0x"
			+ this.wordToHex(d), 16)) % 4294967296).toString(16);
